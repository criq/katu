...
{
	public function filterByBasename(string $basename): FileCollection
	{
		return new static(array_values(array_filter($this->getArrayCopy(), function (File $file) use ($basename) {
			return $file->getBasename() == $basename;
		})));
	}

...
class Profiler {
	...
	public function getPath() {
		$path = \Katu\Utils\Tmp::getPath(['!profiler', \Katu\Utils\Url::getCurrent(), '!' . (new \Katu\Tools\Calendar\Time())->format('Y-m-d-H-i-s') . '-' . \Katu\Tools\Calendar\Time::getMicroseconds()]);
